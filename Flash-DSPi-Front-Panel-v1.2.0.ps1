...
$Engine = Join-Path $Root "Build-and-Flash-DSPi-Front-Panel-v1.2.0.ps1"

if (-not (Test-Path -LiteralPath $Engine -PathType Leaf)) {
    throw "v1.2.0 build and flash engine not found: $Engine"
}
...
if ($LASTEXITCODE -ne 0) {
    throw "DSPi ESP32 Front Panel v1.2.0 failed with exit code $LASTEXITCODE."
}
